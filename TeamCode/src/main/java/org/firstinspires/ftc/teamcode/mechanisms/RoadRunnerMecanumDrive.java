...
//        final double angle = Math.toRadians(direc * 154);
//        Trajectory toHub = this.trajectoryBuilder(goForward.end())
//                .splineToLinearHeading(new Pose2d(25.5, direc * 8.69, angle), Math.toRadians(direc * 90))
//                .build();
...
//        final double angle = Math.toRadians(direc * 154);
        final double dist = 45;
//        Trajectory goBack = this.trajectoryBuilder(new Pose2d(25.5, direc * 8.69, angle))
//                .splineToLinearHeading(curr, Math.toRadians(angle))
//                .build();
//        this.followTrajectory(goBack);
        Trajectory reverse = this.trajectoryBuilder(curr)
                .strafeLeft(dist)
                .build();
